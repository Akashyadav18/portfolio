...
const ImageIcon = () => {
  return (
    <motion.div className='h-full w-full ring-8 ring-color2 rounded-full shadow-lg' initial={{ x: "-100%", opacity: 0}} whileInView={{ x: 0, y: 0, opacity: 1,}} transition={{ delay: 0.1 }}>
