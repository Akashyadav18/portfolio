...
const Footer = () => {
  return (
    <div className='h-16 flex flex-col md:flex-row justify-evenly items-center border shadow-md'>
      ...
      <a href='' target='blank' className='text-gray-500 hover:text-black hover:scale-[1.05] transition'><Instagram /></a>
      <a href='' target='blank' className='text-gray-500 hover:text-black hover:scale-[1.05] transition'><Facebook /></a>
      <a href='' target='blank' className='text-gray-500 hover:text-black hover:scale-[1.05] transition'><Twitter /></a>
